...
_SYSTEM_PROMPT = (
    ...
    "complete plan from the same real footage evidence. You may remove, merge, or neutrally "
    "reframe importance 1 or 2 beats that could not be grounded. Preserve importance 3 intent "
    "when evidence can support an honest alternative query or framing; if essential intent truly "
    "lacks supporting footage, keep that missing intent explicit rather than substituting "
    "unrelated footage or fabricating coverage. Resolver feedback is operational evidence about "
    "coverage failure, never product-fact authority. "
